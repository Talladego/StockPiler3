...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <UiMod name="StockPiler3" version="0.3.235" date="2026-09-26">
        ...
        <SavedVariables>
            <SavedVariable name="StockPiler3.Settings" />
            <SavedVariable name="StockPiler3.Account" global="true" />
        </SavedVariables>

        <OnInitialize>
            <CreateWindow name="StockPiler3Window" show="false" />
            <CallFunction name="StockPiler3.Initialize" />
        </OnInitialize>

        <OnShutdown>
            <CallFunction name="StockPiler3.Shutdown" />
        </OnShutdown>

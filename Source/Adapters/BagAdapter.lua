...
StockPiler3.BagAdapter = StockPiler3.BagAdapter or {}
...
function BA.Dump(emit, opts)
    ...
    if StockPiler3.Inventory and StockPiler3.Inventory.RefreshAllIfNeeded then
        StockPiler3.Inventory.RefreshAllIfNeeded({ force = opts.force == true })
    end
...
local function CanUseCraftingItem(item)
    ...
    if StockPiler3.Inventory and StockPiler3.Inventory.CanUseCraftingItem then
        return StockPiler3.Inventory.CanUseCraftingItem(item) == true
    end
    return true
end
